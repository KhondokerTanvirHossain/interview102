...
public class MovieRatingSpecification {

    public static Specification<MovieRatingDatabaseEntity> getFilterSpecifications(Map<String, String> filters, Metamodel metamodel) {
        EntityType<MovieRatingDatabaseEntity> entityType = metamodel.entity(MovieRatingDatabaseEntity.class);
    ...
    public static Specification<MovieRatingDatabaseEntity> getListFilterSpecifications(Map<String, List<String>> filters, Metamodel metamodel) {
        EntityType<MovieRatingDatabaseEntity> entityType = metamodel.entity(MovieRatingDatabaseEntity.class);
