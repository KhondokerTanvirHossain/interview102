...
public class MovieInfoSpecification {
    ...
    public static Specification<MovieCatalogDatabaseEntity> getFilterSpecifications(Map<String, String> filters, Metamodel metamodel) {
        EntityType<MovieCatalogDatabaseEntity> entityType = metamodel.entity(MovieCatalogDatabaseEntity.class);
    ...
    public static Specification<MovieCatalogDatabaseEntity> getListFilterSpecifications(Map<String, List<String>> filters, Metamodel metamodel) {
        EntityType<MovieCatalogDatabaseEntity> entityType = metamodel.entity(MovieCatalogDatabaseEntity.class);
